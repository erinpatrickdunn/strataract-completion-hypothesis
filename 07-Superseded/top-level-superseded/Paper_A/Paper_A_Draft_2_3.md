...
| Chirality inversion per cosmological cycle ($A^\mu \to -A^\mu$) | 2.10a | **OPEN QUESTION — NOT GENERIC** | IVN-I (June 2026, Appendix P v13) redid the PT-1 monodromy calculation in a consistent metric convention. Chirality inversion is confirmed non-generic — it requires a non-topologically-protected fine-tuning of action parameters, not a default consequence of $S^3$ geometry. See Section 2.10a. |
...
Note that this galactic/nuclear-scale η evolution equation is distinct from the cosmological η evolution law of Section 2.10a and Appendix P Section P.7.7.3 — the latter concerns how the cosmological background value of η evolves across a bounce cycle in the presence of a nonzero axial current, and is a separate (and separately revised) calculation from the thermal decoherence law here.
...
*[Revised in Draft 2.3. This section previously stated, following the original v5–v11 Appendix P text, that "the standard spin representation on S³ predicts chirality inverts at every bounce," treating alternating matter/antimatter cycles as close to a default consequence of the geometry. Appendix P v12 already revised this (the PT-1 analysis programme found no topological mechanism forcing $A^\mu \to -A^\mu$), and Appendix P v13 — following IVN-I, which corrected a metric-signature convention error in the v12 monodromy calculation — confirms that revision while adding a further wrinkle. This section is rewritten below to match the current Appendix P status rather than the superseded original claim.*]
...
Whether $A^\mu$ inverts sign across a bounce — successive cycles alternating between matter-dominated and antimatter-dominated — is **not** a default topological consequence of $S^3$ geometry. Appendix P Section P.7.7 derives the cosmological evolution of $(A^0, P)$ from the cosmological Dirac equation and finds that the transformation of $A^\mu$ over one full cycle is the holonomy of a $\mathrm{U}(1)$ connection on the condensate axial-current bundle, with phase $\Phi_{\text{cycle}}$ set continuously by the action parameters $\{m, \lambda, \kappa\alpha\}$ and the cycle duration. A full sign inversion ($A^\mu \to -A^\mu$, i.e. holonomy $-\mathbf{1}$) requires $\Phi_{\text{cycle}}$ to land on an odd multiple of $\pi$ — a condition with no topological protection, confirmed non-generic by two independent derivations (the original PT-1 calculation and its IVN-I convention correction, which agree on this qualitative conclusion despite disagreeing on the detailed structure of the underlying system).

A second finding, new as of the IVN-I correction (Appendix P v13, Section P.7.7.3a), is that in the torsion-active branch of the cosmology (Branch 2, $A^\mu \neq 0$), the scalar condensate $\eta$ is itself sourced by the product $\kappa\alpha A^0 P$ and does not evolve independently of the chirality sector. This was not visible in earlier derivations. Its quantitative size is an open item (IVN-I-3, CRITICAL).

**What this means for matter accumulation.** The physical mechanism proposed for within-cycle matter surplus — sympathetic nucleation, in which a nonzero $\langle A^0\rangle$ during the matter-creation epoch biases vacuum pair-creation toward same-chirality pairs — does **not** depend on whether $A^\mu$ inverts at every bounce. It depends only on $\langle A^0 \rangle \neq 0$ at the start of the current cycle's matter-creation epoch, whatever the sign or history of that value. The current matter dominance reflects the accumulated chirality state inherited from all previous cycles through the (corrected) holonomy, not a simple alternation. Within any matter-dominated cycle, sympathetic nucleation proceeds as before: vacuum pair-creation events can produce two matter particles of the same chirality rather than the standard matter-antimatter pair, and this within-cycle matter surplus remains the proposed explanation for why early-universe galaxies are more massive than ΛCDM predicts (full treatment in Appendix C).

**What changed and what didn't.** The physical mechanism (sympathetic nucleation) and its connection to the JWST early-massive-galaxy anomaly (Section 1.4) are unchanged. What is retracted is the earlier framing that cycle-to-cycle alternation was close to automatic; what is added is the recognition, from IVN-I, that $\eta$ and the chirality sector are more tightly coupled in Branch 2 than previously modelled. Both the magnitude of the within-cycle surplus and the cycle-to-cycle chirality pattern remain parametric, pending the Bi-209 calibration and the outstanding PT-1/PT-3 and IVN-I-3 calculations. See Appendix P Section P.7.7 for the full derivation and Section P.10 for the CT-ix Branch 2 caveat.
...
- CT-x: Bogoliubov analysis of sympathetic nucleation (PT-2). **Status note (Draft 2.3):** this calculation now proceeds from the IVN-I-corrected $(A^0, P)$ system of Appendix P Section P.7.7.3 rather than the earlier mixed-convention system, and its input $\langle A^0 \rangle$ is understood to be the accumulated holonomy value discussed in Section 2.10a, not a value fixed by an assumed per-cycle sign inversion.
...
Full specifications for CT-xix and CT-xx in Appendix P v9, Section P.8. Full specification of the IVN-I correction and its effect on PT-1/CT-x in Appendix P v13, Section P.7.7.
...
Draft 2.3 revises Section 2.10a: the earlier claim that chirality inversion across the bounce is close to a default topological consequence is retracted, following the PT-1 analysis programme and its IVN-I convention correction (Appendix P v13). Chirality inversion per cycle is confirmed non-generic; the sympathetic nucleation mechanism for within-cycle matter surplus is unaffected and continues to depend only on $\langle A^0 \rangle \neq 0$, whatever its cycle-to-cycle history; a new coupling between the scalar condensate and the chirality sector in the torsion-active cosmological branch is identified as an open item.
...
*Appendices A, B, and C are unchanged from Draft 1.5 and are carried forward in the submission package. Appendix P is updated to v13.*

---

**End of Paper A — Draft 2.3**
