...
| Leptonic mass modification: $\Delta m \sim \alpha \eta m$ | 2.1 | **PREDICTION** | Follows from $$S_{\text{geo}}$$ minimal coupling to S_matter. Mass-scaling is structural. CT-xiv required for quantitative derivation. |
