...
*New in this revision. Resolves CT-xxi as posed in the DESI-audit thread:
whether the (η, A⁰, P) / C_μν sector, via its local fluctuations δη, δP,
contributes to linear-order cosmological structure growth (as opposed to
the background expansion route already closed in Section P.10/P.7.7, or
the transport routes closed under Theorem 4b).*
