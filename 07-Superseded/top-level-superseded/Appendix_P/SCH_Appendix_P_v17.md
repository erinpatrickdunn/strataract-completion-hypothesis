...
**Working Proof Document — v17 | June 2026**

Revised from v16: **This is a full-text audit-integration pass**,
applying in place the eleven classification corrections identified in
`SCH_Project_Wide_Audit_Report_v1.md`, Section 2 (items P-1 through
P-11). Per the Reconstruction Firewall stated in that audit report, this
revision changes **no equation, no coefficient, and no numerical
result**. Every change below is one of: **RECLASSIFY** (a label is
corrected), **DECOMPOSE** (a bundled claim is split into sub-claims,
each with its own label), or **FLAG** (an explicit Category-3 hypothesis
marker is attached where the physical content was previously presented
without one). Two new physical premises are formalized as CP-01 and
CP-02. One new open item is added to the gap table (Gap 20: provenance
of the tree-level $(\eta,P)$ condensate potential used in Section P.11).
All content not touched by these eleven items is carried forward
unedited from v16, per this document's own no-elision policy — restored
in this pass after a prior audit-only patch-list version of this
revision was judged, on request, to bury the corpus's own reproduction
standard rather than serve it. Supersedes v16 and the interim patch-list
draft.

Revised from v15: **New Section P.12 resolves CT-xxi** (the linear-perturbation
/ growth-of-structure question raised in the DESI audit thread). Two results:
(1) the coherence length λ_coh = ħ/(m_eff c) at the framework's own stated
m_eff ~ 1–1.6×10⁻⁶ eV is ~0.1 m, not the ~10¹⁴ m asserted in Paper C §5.1 —
that figure is a numerical error, corrected here and flagged for correction
at its source. (2) This screening scale places the condensate sector deep in
the non-propagating, locally-slaved regime at every scale relevant to
large-scale-structure surveys, closing the "SCH modifies structure growth"
route to a DESI connection on structural grounds, contingent only on m_eff
remaining within the range already used self-consistently throughout this
framework. New Gap 19 added to the status tables. Supersedes v15.
...
| Gap 3 — Gamma_decoh, Gamma_recoh | **CONDITIONAL — PROVENANCE UNDOCUMENTED** (downgraded from DERIVED; audit item P-6) | Functional form stated, P.4; explicit Matsubara evaluation not shown; CT-i remains the open numerical/derivational target |
...
| Gap 6 — S³ spatial topology | **COMPATIBILITY** (relabeled from ESTABLISHED; matches Paper A's Reader Roadmap entry — audit item P-3, CI-01 resolved) | $S^3$ is *a* topology compatible with, and requiring no additional structure beyond, the $\mathrm{SU}(2)\times\mathrm{SU}(2)$ covering group. Not shown to be the unique topology compatible with that covering group under all possible constructions — only the unique one requiring no extra input under the specific construction given. P.7.6.1–P.7.6.2 |
...
| Gap 9 — Physical primitive: ψ as derived object, not ansatz | **ESTABLISHED, resting on an explicitly flagged Category-3 premise (CP-01; audit item P-7)** | P.0b: ψ is presented as the unique minimal 4D rotational encoder given requirements R1–R4; R1–R2 are standard, R3–R4 are a stated physical premise, not a neutral mathematical requirement. $S_{\text{geo}}$ follows as consequence given R1–R4. Theorem 0. |
| Gap 10 — W-spin as mass: η as physical rotational departure | **DECOMPOSED (audit item P-5, P-8).** (10a) $\eta=\bar\psi\psi$ is a Lorentz scalar and may be labeled the "w-spin magnitude": **ESTABLISHED**. (10b) The specific quantitative formula $m_{\text{eff}}^2=m^2-\lambda\eta_{\text{eq}}^2/2$: **CONDITIONAL — PROVENANCE UNDOCUMENTED**. (10c) The physical narrative of a literal w-axis embedding coordinate: **Category-3 premise, CP-02**, an elaboration of Paper A Axiom 0.2, not an independent derivation. | Theorem 0 |
| Gap 11 — c as tangential S³ velocity: speed of light derived | **DECOMPOSED (audit item P-9).** (11a) $c(t)=\omega(t)\cdot R_{\text{cosmic}}(t)$, given the stated setup: **ESTABLISHED**. (11b) The photon-as-minimum-w-spin-surface-wave narrative and the inference from lensing to $\eta_{\text{photon}}=\eta_{\min}$ specifically: **CONDITIONAL**, a physical premise in the same family as CP-02. | Theorem 5 |
| Gap 12 — Matter-light phase transition: topological distinctness | **DECOMPOSED (audit item P-10).** (12a) The general Landau-theorem argument that broken- and symmetric-phase states are topologically distinct: **ESTABLISHED**. (12b) The specific first-order-transition claim resting on an unexhibited one-loop cubic-term calculation: **CONDITIONAL — PROVENANCE UNDOCUMENTED**, inheriting Gap 3's status. | Theorem 6 |
...
| Gap 16 — Cosmological dynamics: solution structure of the modified Friedmann system | **DECOMPOSED (audit item P-1).** (16a) Branch 1 two-phase dynamics, $R_{\text{universe}}$, CMB quadrupole constraint on $m\eta_0$: **ESTABLISHED**, unaffected throughout this sector's entire revision history. (16b) Branch 2 existence and coefficient of the $\kappa\alpha A^0P$ source term: **ESTABLISHED** (three independent derivation routes). (16c) The claim that the Branch 2 late-time correction is "parametrically small": **CONDITIONAL — PROVENANCE UNDOCUMENTED**; no bound is derived, only asserted as an expectation. | Section P.10 in full below |
| Gap 17 — Term 2 carrier structure | **DECOMPOSED (audit item P-2).** (17a) Qualitative nondegeneracy of two carrier channels, from the explicit chiral-breaking term $-m\bar\psi\psi$: **ESTABLISHED**. (17b) The quantitative GMOR mass ratio $m_P^2/m_\eta^2$: **CONDITIONAL — DOWNSTREAM DEPENDENCY** on Gap 20 (the potential of Section P.11.2). | Section P.11.1–P.11.2, P.11.4 |
...
| Gap 19 — Condensate screening scale and linear-perturbation (growth-of-structure) contribution to cosmological structure | **CLOSED (negative)** | λ_coh = ħ/(m_eff c) ≈ 0.1 m at the framework's own stated m_eff, screening the condensate sector out of any linear cosmological perturbation at survey-relevant scales (k ≲ Mpc⁻¹). Corrects a ~10¹⁵-order-of-magnitude error in Paper C §5.1. See Section P.12. |
| Gap 20 — Provenance of the tree-level $(\eta,P)$ condensate potential | **OPEN (new; audit item P-11)** | The $-m\eta$ term in $V(\eta,P)$ (Section P.11.2) is a direct readout of $S_{\text{geo}}$; the full $(\eta^2+P^2)$/$(\eta^2+P^2)^2$ structure is an unexhibited-bosonization ansatz, not shown to follow uniquely from $S_{\text{geo}}$'s literal $\eta$-only quartic term. Gap 17b, the Theorem 2 v15 note, and the Theorem 0 Step 3 reconciliation attempt all inherit this status. |

The framework has a closed variational structure within its stated EFT
and mean-field condensate regime, subject to the classification
corrections in this revision. All claims are regime-conditional, and a
subset are additionally conditional on the provenance items newly
tagged above. The density hierarchy is explicit and bounded. Sections
P.7.5, P.7.6 cover black hole and topological predictions unaffected by
any version of the chirality-sector revision, except that P.7.5's
quantitative frequency table is retracted per Section P.11 (Gap 5a
above), and Gap 6's topology claim is now labeled COMPATIBILITY rather
than ESTABLISHED (audit item P-3). Section P.7.7 and Section P.10 are
rewritten in full below, closing the freeze opened in v13.1, and are
confirmed unaffected by the v15 Theorem 4 split; Section P.10's Branch 2
late-time claim carries the new (16c) qualification. Section P.11 (new
in v15) supplies the carrier structure and transport derivation that
Theorem 4 never provided, and is itself now partially qualified by Gap
20 (audit item P-11).
...
$$C_{\mu\nu} = \rho\,\eta\,u_\mu u_\nu = Q_{\mu\nu}$$
$$\eta = \bar{\psi}\psi \quad (\text{Lorentz scalar by Theorem 2; w-spin magnitude by Theorem 0, Category-3 premise CP-02})$$
...
**TOPOLOGY:** $\mathrm{SU}(2)$ as group manifold $= S^3$ $\Rightarrow$ spatial topology *compatible with* $S^3$, requiring no additional structure (P.7.6; relabeled COMPATIBILITY, audit item P-3)

**GROUND FLOOR:** $\psi$ presented as minimal rotational encoder in 4D given requirements R1–R4 (R3–R4 flagged as Category-3 premise CP-01); $\eta$ identified as w-spin magnitude (Category-3 premise CP-02); $c$ derived as tangential S³ velocity given the stated setup; photon identified as minimum-w-spin surface wave, with the specific $\eta_{\min}$ identification flagged as conditional (P.0b, Theorems 0, 5, 6)
...
**CARRIER/TRANSPORT SECTOR** (new in v15, qualified in v17): Term 2 is carried by two
generically nondegenerate condensate fluctuations, $\delta\eta$ and
$\delta P$ (qualitative claim ESTABLISHED), whose transport is a derived damped relativistic wave
equation rather than an asserted diffusion formula. The quantitative GMOR mass relation between the two channels is CONDITIONAL, resting on the not-yet-derived potential of Section P.11.2 (Gap 20).
...
Channel A (Term 1 ↔ Term 2): Condensate decoherence/recoherence. Governed by $u^\mu\nabla_\mu\eta = -\Gamma_{\text{decoh}}\,\eta + \Gamma_{\text{recoh}}\,(1-\eta)$. Rates stated in functional form (Theorem 3; status downgraded, see Gap 3 above). Full $\nabla^\mu T_{\mu\nu}^{\text{total}} = 0$ verification: OPEN TARGET.
...
Closed: $\nabla^\mu C_{\mu\nu} = 0$ at leading order (Theorem 1, Appendix A); $\nabla^\mu T_{\mu\nu}^{\text{torsion}} = 0$ in the parity-preserving vacuum (Theorem 2); the Branch 2 self-coupling channel's existence and coefficient (Section P.7.7, this version). Conditional: the $\eta$ evolution rate functions (Theorem 3, Gap 3). Open channels are all in regimes beyond the galactic-scale observational programme and are identified calculational targets, not foundational gaps.
...
Section P.0b fills that gap. The claim is that $\psi$ is not introduced as a mathematical convenience. It is presented as the unique minimal mathematical object capable of encoding rotational state in four-dimensional curved spacetime, given the requirements R1–R4 stated below — a subset of which (R3, R4) are themselves a physical premise rather than a neutral mathematical necessity (see the classification note at the end of P.0b.2). The argument has four steps: (i) identify what a physical primitive of rotation requires a mathematical object to do; (ii) enumerate the candidate objects in 4D Riemannian geometry; (iii) show by elimination that the spinor field is the unique minimal candidate given R1–R4; (iv) show that $S_{\text{geo}}$ is the most general local action for that object consistent with the symmetries of the problem.
...
**[CLASSIFICATION: CP-01, Category-3 physical premise (audit item
P-7).** R1 and R2 are standard field-theoretic requirements, imposed by
any local, Lorentz-covariant theory and not specific to SCH. R3 and R4
are not derivable mathematical requirements — they encode a prior
commitment (rotation-as-primitive implies a *single, minimal, all-plane
-sensitive* encoder must exist and must be identified with the physical
degrees of freedom of matter) rather than following from anything
external to the framework. A theory-builder could equally well start
from a different commitment — for instance, that the primitive is a
scalar order parameter, or that the primitive is an antisymmetric
tensor field whose extra components are physically meaningful rather
than redundant — and such a choice would fail R3/R4 as stated without
being mathematically inconsistent. The enumeration-and-elimination
argument of P.0b.3 below is internally valid *given* R1–R4; R3 and R4
should be read as stated hypotheses of the SCH framework, not as
neutral mathematical requirements that any theory of 4D geometry must
satisfy.]**
...
**Result of enumeration:** Given R1–R4, the Dirac spinor $\psi$ is the unique object satisfying them simultaneously. Scalars and single vectors fail R3. Antisymmetric tensors fail R4. Weyl spinors fail R3. The Dirac spinor is the minimal complete rotational encoder in 4D curved spacetime under the stated requirement set — a set which, per the classification note in P.0b.2, is itself a physical premise (CP-01) rather than a neutral mathematical necessity.

## **P.0b.4 The Action as Consequence**

Given that $\psi$ is the minimal rotational encoder under R1–R4, the action $S_{\text{geo}}$ is the most general local, Lorentz-invariant, generally covariant action for $\psi$ that is at most quartic in the field and its first derivatives. The Dirac kinetic term $\bar{\psi}\gamma^a e^a_\mu D_\mu \psi$ is the unique kinetic term at quadratic order. The mass term $m\bar{\psi}\psi$ is the unique mass-dimension-4 quadratic interaction. The quartic self-coupling $(\lambda/4)(\bar{\psi}\psi)^2$ is the unique quartic scalar self-interaction consistent with the symmetries of the action. Higher powers of $\psi$ are suppressed by powers of the Planck mass in the EFT sense and are not included at leading order.

The action $S_{\text{geo}}$ is therefore not a freely chosen ansatz. Given R1–R4, it is the unique leading-order action for the unique minimal rotational encoder in 4D curved spacetime, written in terms of the tetrad $e^a_\mu$ and spin connection $\omega^{ab}_\mu$ that define the curved-spacetime geometry.

**Corollary P.0b.4:** The derivation chain of the framework is complete at the ground floor *conditional on R1–R4 (CP-01)*. The physical primitive (rotation is fundamental) together with R1–R4 uniquely determines the mathematical object ($\psi$ = Dirac spinor) which uniquely determines the action ($S_{\text{geo}}$ = leading-order action for $\psi$). No unjustified *mathematical* choices are made at any stage beyond the initial physical premise; that premise itself is now explicitly flagged rather than left implicit.
...
**[CLASSIFICATION note, added this revision.** Items (i)–(iii) above are
the physical-narrative content of this theorem. As established below in
the classification box at the Conclusion, this narrative is Category-3
premise **CP-02** — an elaboration of Paper A's Axiom 0.2 within
Appendix P's formalism, not an independent derivation. The mathematical
content this narrative rests on (Theorem 2's scalar-bilinear proof) is
unaffected and remains established.]**
...
**[CLASSIFICATION: this specific quantitative formula is `CONDITIONAL
— PROVENANCE UNDOCUMENTED` (audit item P-5).** No effective potential
$V_{\text{eff}}(\eta)$ is minimized explicitly in this proof to produce
it; it is asserted by analogy to the qualitative balance described in
the preceding sentence. Compare P.11.2, which derives a related but
numerically distinct quantity, $m_\eta^2 = 2\lambda\eta_{\text{eq}}^2$,
from an explicitly stated potential — the discrepancy between the two
is noted, but not resolved, in P.11.2's own text. The identification of
$\eta = \bar\psi\psi$ itself as the physical w-spin magnitude (Steps
1–2 above, and the Conclusion) is a separate claim (CP-02, see below)
and is unaffected by this tag; the scalar-bilinear mathematics
underlying it (Theorem 2) retains its established status as a piece of
mathematics, independent of the physical interpretation layered on top
of it.]**
...
completion of Theorem 0 Step 3, not a revision of it, though both the
completion and the original are now tagged CONDITIONAL — see the boxes
above and at P.11.2 (Gap 20).
...
**[CLASSIFICATION: CP-02, Category-3 physical premise (audit item
P-8).** The mathematical content of this theorem — $\eta=\bar\psi\psi$
is a Lorentz scalar (Theorem 2) and can be assigned a physically
meaningful role in the mass term of $S_{\text{geo}}$ — is
`ESTABLISHED`. The specific physical identification of that scalar
with "rotational departure along a literal $w$-axis embedding
coordinate" is the same premise stated as **Axiom 0.2** in Paper A
("Matter is a Localized Topological Soliton with w-axis spin"). This
theorem is best understood as an elaboration of that axiom within
Appendix P's formal apparatus, not as an independent derivation that
establishes the axiom from more basic principles. Theorem 2's actual
proof content (scalar transformation law) does not by itself
distinguish this physical picture from other physical pictures
compatible with the same mathematics — a different embedding narrative,
or no embedding narrative at all (treating $\eta$ as an abstract order
parameter with no fourth-dimensional interpretation), would be equally
compatible with Theorem 2's mathematics.]**
...
**[CLASSIFICATION note, added this revision.** As detailed in the
classification box at the end of Step 3 below, this Theorem bundles two
claims of different strength (audit item P-9): the boxed relation
$c(t)=\omega(t)R_{\text{cosmic}}(t)$, `ESTABLISHED` given the stated
setup; and the specific photon-as-minimum-w-spin-surface-wave physical
picture, `CONDITIONAL`.]**
...
**[CLASSIFICATION (audit item P-9).** Split into: **(11a)** the boxed
relation $c(t)=\omega(t)R_{\text{cosmic}}(t)$ itself, taken as a
consequence of the stated setup (maximum-speed signal = tangential
surface motion of a rotating $S^3$): `ESTABLISHED`, given that setup.
**(11b)** Steps 1–2 above — the identification of photons as literally
"minimum-w-spin surface waves," and the inference that gravitational
lensing specifically confirms $\eta_{\text{photon}}=\eta_{\min}>0$
rather than merely confirming *some* nonzero photon-condensate
coupling — is `CONDITIONAL`, a physical premise in the same family as
CP-02, not a proof compelled by the lensing observation alone. Lensing
rules out $\eta_{\text{photon}}=0$ exactly; it does not by itself
establish that $\eta_{\text{photon}}$ takes the specific value
$\eta_{\min}$ postulated here as opposed to some other small nonzero
coupling mechanism.]**
...
**[CLASSIFICATION note, added this revision.** As detailed in the
classification box at Step 4 below, this Theorem bundles the general
Landau-theorem argument (Step 3, `ESTABLISHED` given the setup) with a
specific first-order-transition claim (Step 4, `CONDITIONAL —
PROVENANCE UNDOCUMENTED`, audit item P-10).]**
...
$P$ direction — see Section P.11 for the consequences, and Gap 20 for
this potential's own provenance status.
...
**[CLASSIFICATION: (12a) — audit item P-10.** The general Landau-theorem
argument of Step 3 — a genuine order parameter's broken and symmetric
phases are topologically distinct, given the (corrected) symmetry
identification above — is `ESTABLISHED`; this is standard statistical
field theory, correctly applied given the setup.]**
...
**[CLASSIFICATION: (12b) — audit item P-10.** The specific claim that
the transition is *first-order* (as opposed to second-order), resting
on "the cubic term generated in $V_{\text{eff}}(\eta,T)$ by thermal
fluctuations at one loop," inherits Theorem 3's own unresolved
provenance status (audit item P-6, Gap 3) — no such one-loop cubic term
computation is exhibited anywhere in this document. This sub-claim is
`CONDITIONAL — PROVENANCE UNDOCUMENTED`.]**
...
By P.0b (given the R1–R4 requirement set, CP-01), $S_{\text{geo}}$ is the unique leading-order action for the unique minimal rotational encoder $\psi$ in 4D curved spacetime. By Theorem 0 (physical content, CP-02), the mass parameter $m$ is the w-spin restoring force scale. By Theorems 5 and 6, the action admits two phases of its condensate solution: the matter phase $(\eta \neq 0)$ and the light phase $(\eta = 0)$.
...
where the Fock–Weyl covariant derivative is $D_\mu\psi = \partial_\mu\psi + \tfrac{1}{4}\omega_\mu^{ab}[\gamma_a,\gamma_b]\psi$. The parameter $\lambda > 0$ governs the quartic self-interaction and sets the condensate scale. By Theorem 6, $\lambda > 0$ is the necessary and sufficient condition for a first-order matter-light phase transition, subject to the (12b) qualification above regarding the specific one-loop mechanism claimed to produce first-order (rather than second-order) behavior; $\lambda \leq 0$ would give no condensate and no matter phase, only the light phase everywhere — this direction of the argument is unaffected by the (12b) qualification.

Note also, for cross-reference to Section P.11 (Gap 20): the quartic term above is written with $\bar\psi\psi = \eta$ alone, not $(\eta^2+P^2)$. Any potential used downstream that extends this to a joint $(\eta^2+P^2)^2$ form (as in P.11.2) is doing so by an ansatz beyond what is written here, and should be read accordingly.
...
*(No action item from the audit applies to this section — confirmed sound.)*
...
*Note (v15).* The parity-preserving condition $P=0$ assumed here is
claimed in Section P.11.2 to follow from the minimum of a proposed
tree-level $(\eta,P)$ potential, rather than being merely assumed.
**[CLASSIFICATION: CONDITIONAL — DOWNSTREAM DEPENDENCY. See audit item
P-4 and P-11 (Gap 20).]** This "derivation" holds only if the P.11.2
potential is itself the correct potential following from
$S_{\text{geo}}$, which has not been independently shown. Theorem 2's
original proof (Fierz identity + assumed parity-preserving vacuum,
above) is unaffected either way and retains its original regime
-conditional `ESTABLISHED` status on its own terms.
...
$\Gamma_{\text{decoh}} = (\alpha/m^2)(\lambda\rho)^2\kappa(T)$ and $\Gamma_{\text{recoh}} = (\alpha/m^2)(\lambda\rho)^2\kappa(T)f(T)$, where $\kappa(T) = d^2V_{\text{eff}}/d\eta^2$ evaluated at $\eta_{\text{eq}}(T)$ and $f(T) = \eta_{\text{eq}}(T)/\eta_{\text{max}}$. Both rates are fixed by action parameters $\{\alpha, \lambda, m\}$ and temperature $T$.

**[CLASSIFICATION: CONDITIONAL — PROVENANCE UNDOCUMENTED (audit item
P-6).** The stated functional forms are asserted; no Matsubara sum, no
self-energy diagram, and no explicit evaluation or regularization
scheme are exhibited in this document to derive them from
$S_{\text{geo}}$. CT-i (P.8) — "numerical evaluation of $\kappa(T)$" —
being listed as a remaining open target is consistent with this: the
functional *form* is a working hypothesis pending the calculation that
would actually close it, not a completed derivation awaiting only
number-crunching. The claim "no free parameters remain" should be read
as "no *additional* free parameters beyond $\{\alpha,\lambda,m\}$ are
introduced by this ansatz," not as "this has been derived from first
principles."]**

Derived from $S_{\text{geo}}$ via the finite-temperature effective potential computed by the Matsubara formalism — a derivation whose intermediate steps (Hubbard-Stratonovich transform, fermion determinant, regularization scheme) are not exhibited in this document; see the classification box above.

*Note (v15).* $\Gamma_{\rm decoh}$ is evaluated at $\omega=k=0$ — the
...
revision beyond the classification tag above; it is one extraction of
the underlying self-energy function among several now identified —
both extractions inherit the same undocumented-provenance status.
...
| --- | --- | --- |
| Lagrangian architecture | **CLOSED, conditional on R1–R4 (CP-01)** | $S_{\text{geo}}$ is the Einstein-Cartan-Dirac action with quartic spinor coupling, given the requirement set of P.0b.2. Metric variation gives the field equation exactly. (P.1) |
...
| $\eta$ scalar nature | **CLOSED** | $\eta = \bar{\psi}\psi$ is a Lorentz scalar bilinear; proven from spinor transformation law under SL(2,C). (P.3 — Theorem 2). The *physical interpretation* of this scalar as "w-spin" is a separate claim, CP-02, tracked under Theorem 0. |
...
| $\Gamma_{\text{decoh}}$, $\Gamma_{\text{recoh}}$ | **CONDITIONAL — PROVENANCE UNDOCUMENTED** (downgraded from CLOSED; audit item P-6) | Theorem 3: functional forms stated; explicit Matsubara evaluation not exhibited. Fixed by $\{\alpha, \lambda, m, T\}$ as an ansatz. (P.4) |
| $u^\mu$ normalization | **CLOSED (regime-conditional), on its original proof** | Theorem 2: $u^\mu u_\mu = -c^2$ in parity-preserving vacuum sector, $S \neq 0$, $\rho \ll \rho_c$, via Fierz identity + assumed parity-preserving vacuum. The additional v15 claim that the parity-preserving assumption is *independently derived* from a tree-level potential is `CONDITIONAL — DOWNSTREAM DEPENDENCY` (audit item P-4); it does not change Theorem 2's own closure status either way. (P.3) |
| Torsion / lensing persistence — carrier structure | **DECOMPOSED (audit item P-2).** (17a) Qualitative nondegeneracy of $\delta\eta,\delta P$: **CLOSED**. (17b) Quantitative GMOR relation: **CONDITIONAL — DOWNSTREAM DEPENDENCY** on Gap 20. | (P.11.1–P.11.2, P.11.4) |
...
| S³ topology | **COMPATIBILITY** (downgraded from CLOSED; audit item P-3, CI-01) | SU(2) group manifold = S³. Spinor field on SU(2) × SU(2) admits S³ canonically via spin structure, requiring no additional input — this is a compatibility/minimal-input result, not a uniqueness proof ruling out all other topologies under all constructions. Matches Paper A's own "COMPATIBILITY" table entry. (P.7.6) |
...
| Physical primitive: $\psi$ as derived object, not ansatz | **CLOSED, conditional on CP-01** | P.0b: $\psi$ is the unique minimal 4D rotational encoder (enumeration + elimination) given R1–R4. $S_{\text{geo}}$ follows as consequence. R3–R4 are flagged as a physical premise, not a neutral requirement. |
| W-spin as mass: $\eta$ as physical rotational departure | **DECOMPOSED (audit items P-5, P-8).** (10a) Scalar-bilinear mathematics: **CLOSED**. (10b) Quantitative $m_{\text{eff}}^2$ formula: **CONDITIONAL — PROVENANCE UNDOCUMENTED**. (10c) Physical w-axis narrative: **CP-02**, elaboration of Paper A Axiom 0.2. | Theorem 0. Completed by the two-field expansion of P.11.2, itself now flagged under Gap 20. |
| $c$ as tangential S³ velocity: speed of light derived | **DECOMPOSED (audit item P-9).** (11a) $c(t) = \omega(t) \cdot R_{\text{cosmic}}(t)$ given the setup: **CLOSED**. (11b) Photon-as-minimum-w-spin narrative: **CONDITIONAL**. | Theorem 5 |
| Matter-light phase transition: topological distinctness | **DECOMPOSED (audit item P-10).** (12a) General Landau-theorem argument: **CLOSED**. (12b) Specific first-order-transition mechanism: **CONDITIONAL — PROVENANCE UNDOCUMENTED**, inheriting Gap 3's status. | Theorem 6. Symmetry identification precision-corrected in P.11.1 (chiral, not vector, rotation). |
...
| Cosmological dynamics: Branch 1 and Branch 2 solution structure | **DECOMPOSED (audit item P-1).** (16a) Branch 1: **CLOSED**. (16b) Branch 2 existence/coefficient: **CLOSED**. (16c) Branch 2 late-time "parametrically small" claim: **CONDITIONAL — PROVENANCE UNDOCUMENTED**. | CT-ix, Section P.10. Confirmed unaffected by the v15 Theorem 4 split — homogeneous-background dynamics, not local fluctuation transport. |
| Term 2 carrier structure | **DECOMPOSED (audit item P-2).** (17a) Qualitative: **CLOSED**. (17b) Quantitative GMOR ratio: **CONDITIONAL**, see Gap 20. | (P.11.1, P.11.2, P.11.4) |
...
| Condensate screening scale / growth-of-structure contribution | **CLOSED (negative)** | Theorem 4b's mass scale, taken at the framework's own stated m_eff, screens the condensate sector out of all survey-relevant cosmological scales. Corrects a numerical error in Paper C §5.1. (P.12) |
| Provenance of the tree-level $(\eta,P)$ condensate potential | **OPEN (new; audit item P-11)** | Section P.11.2's potential extends $S_{\text{geo}}$'s literal $\eta$-only quartic term to a joint $(\eta^2+P^2)^2$ form without an exhibited bosonization derivation. Root dependency for Gap 17b, the Theorem 2 v15 note, and part of Theorem 0's Step 3. |

**FINAL STATUS (v17):** A self-consistent variational structure has
been established within the stated EFT and mean-field condensate
regime, subject to the classification corrections applied in this
revision. All leading-order claims are regime-conditional on $\rho \ll
\rho_c$ and $T < T_c$, and a subset are additionally conditional on the
provenance items newly tagged (Gaps 3, 10b, 12b, 16c, 17b, 20; premises
CP-01, CP-02). The Strataract Completion Hypothesis remains a self
-consistent variational EFT rooted in the Einstein-Cartan-Dirac action.
GR is the exact torsion-free limit ($\eta = 0$, $A^\mu = 0$) — this
result is unaffected by any item in this revision. All galactic-scale
claims hold in the regime $\rho \ll \rho_c$. The ground-floor derivation
(P.0b, Theorems 0, 5, 6) establishes $\psi$ as an object that is unique
*given* R1–R4 (CP-01), $\eta$ as w-spin magnitude *given* the physical
identification CP-02, $c$ as the S³ surface velocity as a clean
consequence of the stated setup, and matter-light as a first-order
phase distinction whose topological character (12a) is solid and whose
specific first-order mechanism (12b) is not yet independently derived.
The chirality/Branch-2 sector, frozen since v13.1, was closed in v14 for
its mechanism and coefficient (16a, 16b); its late-time smallness claim
(16c) is now separately flagged. **Carried from v15:** the Theorem 4
split establishes that Term 2's carrier structure is qualitatively
closed (17a) while its quantitative mass relation (17b) and its
transport regime (Gap 18) remain open, the former newly so as of this
revision. CT-xix and CT-xx remain open targets, unaffected by any
closure in this document. **New in v17:** eleven classification
corrections applied throughout (audit items P-1 through P-11), two new
Category-3 premises formalized (CP-01, CP-02), and one new open item
added (Gap 20, the provenance of the tree-level $(\eta,P)$ potential
underlying much of Section P.11).
...
All numerical values are provisional and scale with $m_{\text{eff}}$. The Bi-209 calibration pins $m_{\text{eff}}$. **(v15: and, per the retraction above, the table additionally awaits CT-vii(a–c) before any of its entries can be trusted at all, independent of the Bi-209 value of $m_{\text{eff}}$.)** (v17: also note this table's own footer text — "consistent with long-range condensate" — is the same numerical claim independently corrected downward by roughly fifteen orders of magnitude in Section P.12.2; see Gap 19.)
...
**[CLASSIFICATION note, added this revision (audit item P-3).** This
section's own prose already carries the appropriate hedge — "a
compatibility and uniqueness argument within [a] class," not an
unconditional uniqueness proof. The correction applied in this revision
is confined to the STATUS SUMMARY and P.6 tables, which previously
read `ESTABLISHED`/`CLOSED` and are now downgraded to `COMPATIBILITY`,
bringing them into agreement with both this paragraph's own language
and with Paper A's Reader Roadmap table, which has carried the more
conservative `COMPATIBILITY` label throughout. No change to the body
text of P.7.6.1–P.7.6.4 is needed.]**
...
Theorem 4 split — see Section P.11.5. Confirmed unaffected by the v17
audit-classification pass except for the single (16c) qualification
applied in Section P.10 below — the mechanism and coefficient
established in this section are not in question.*
...
**Status: no longer an open item, for the mechanism and coefficient.**
Prior versions of this section (v13, v13.1) carried this as CRITICAL
and outstanding, pending verification of the sourcing term itself. That
verification is now complete: three independent routes agree on both
the existence and the magnitude of the sourcing term. What remains open
is not whether $\eta$ is sourced in Branch 2, but how large the effect
is relative to the leading $a^{-3}$ dilution — which depends on
$\alpha$, still pending Bi-209, **and which the audit's item P-1 flags
as currently only asserted to be "parametrically small," not bounded —
see the (16c) classification in Section P.10 below.**
...
subject to Theorem 6's own (12b) qualification). Quantitative
...
is lifted as of v14 and confirmed unaffected by this revision. The
record below is retained in full for audit purposes, since this sector
has now been revised five times (six, counting this classification
pass) and the discipline of showing the full path — not just the
endpoint — is what the project's governance charter identifies as the
...
as settled. **(v17: Gap 16's late-time smallness sub-claim is further
split out and separately flagged — see (16c) and Section P.10 — but
this does not reopen the mechanism/coefficient closure recorded here,
which is unaffected.)**
...
open numbers, gated on CT-vii rather than Bi-209 alone.) (v17: nor is
the provenance of the potential those numbers would be extracted from
— see Gap 20.)**
...
The following items are calculational targets within the closed theory — well-defined computations, not foundational gaps. (Items marked with a classification tag below have had their underlying theorem's status revised by this audit pass; the calculational target itself is unaffected in scope, only in how "closed" the starting point should be read as being.)

**CT-i.** Numerical evaluation of $\kappa(T)$ across intermediate temperatures (stellar interior and galactic-scale regime). Analytic high-T and low-T limits are closed; intermediate regime requires numerical Matsubara integration. *(Cross-reference: Gap 3/Theorem 3 is now CONDITIONAL — PROVENANCE UNDOCUMENTED, audit item P-6; CT-i's scope may in practice include supplying the derivation Theorem 3 currently lacks, not only evaluating a already-closed $\kappa(T)$.)*
...
- *CT-vii(a)* — numerical evaluation of the SCH GMOR ratio
  ...
  regime of P.11.2 is realized. *(v17: this evaluation is only as
  meaningful as the potential it is extracted from — see Gap 20. A
  companion derivational target, not yet separately numbered, is to
  establish that potential's provenance from $S_{\text{geo}}$ in the
  first place.)*
...
Physical content: The propagating spinor condensate $C_{\mu\nu}$ couples to photons via the photon-condensate interaction term in the full action. By Theorem 5 (specifically, the (11b) physical picture, itself CONDITIONAL per audit item P-9), photons carry minimum nonzero w-spin $\eta_{\min}$ and therefore couple to the condensate weakly but measurably — gravitational lensing is direct observational confirmation of this coupling. The photon-condensate cross section $\sigma(\omega)$ governs both the lensing deflection (at short path lengths through concentrated condensate) and the cumulative strataract drag (at cosmological path lengths through the diffuse intergalactic condensate). The coherence damping length $L_{\text{coh}}(\omega) = 1/(n_{\text{condensate}}\,\sigma(\omega))$ determines the transition redshift $z_{\text{flip}}$ above which accumulated drag is sufficient to randomize photon directional and spectral coherence. The CMB monopole temperature $T_{\text{CMB}}$ emerges from the total energy density of this drag-randomized flux as a maximum-entropy (Planck) spectrum. The strataract drag also contributes an additive component to the cosmological redshift of all distant sources, separable in principle by its correlation with integrated line-of-sight matter density (Paper A Section 6.9.0).
...
Theorem 4 split — see Section P.11.5. The Branch 2 late-time claim
receives one new classification tag in this revision — see (16c) below
— which does not reopen the mechanism/coefficient closure.*
...
revision, including this one: (E1) reduces exactly to
$\dot\eta+3H\eta=0$ when $A^0=0$, matching what CT-ix has always
assumed. All Branch 1 results stand without qualification, as they have
since v12.
...
established. **This existence-and-structure claim (16b) is unaffected
by this revision's classification pass.**
...
**[CLASSIFICATION: (16c) — audit item P-1.** The immediately preceding
sentence already self-identifies the gap in the corpus's own words.
This revision adds the formal tag: the smallness claim for the Branch 2
late-time correction is `CONDITIONAL — PROVENANCE UNDOCUMENTED`. No
bound on $\kappa\alpha/H \cdot |A_0^0P_0|/\eta_0$ is derived anywhere in
this document; "parametrically small in a generic regime" describes an
expectation about the order of magnitude, not a computed inequality.
This does not affect (16a) or (16b) — the existence of Branch 1's
solution or the existence/coefficient of the Branch 2 source term — both
of which rest on derivations, not order-of-magnitude expectations.]**

**Revised late-time-attractor statement.** Branch 2 approaches Branch 1
behavior at late times up to this calculable-in-principle, but not yet
numerically bounded, oscillatory correction of fractional size
$\sim\kappa\alpha/H$ (times order-unity oscillating factors). This
supersedes both the pre-v13 claim (clean asymptote, no correction —
incomplete, as v13 first noted) and the v13/clean-room back-and-forth
(source term present but of unknown, possibly order-unity, size — now
resolved to be parametrically small *in expectation*, in the regime
already assumed generic elsewhere in this section, though — per the
(16c) tag above — still not numerically bounded).
...
OQ-CT-ix-3: $\eta$ evolution correction at finite $A^0$ in Branch 2. **Closed as a question of mechanism and coefficient by Section P.7.7.3 above; open as a question of numerical magnitude, pending Bi-209; and, per this revision, explicitly open as a question of derived bound versus asserted expectation (16c), independent of Bi-209.**
...
be used downstream, subject to the (16c) tag on the late-time smallness
claim specifically. The two unrelated clean-room claims about P.9.4.2
...
`SCH_Theorem4_Split_CarrierStructure_v1.md`. Section P.11.2's potential
is flagged in this revision as Gap 20 — see the classification box in
that subsection.*
...
in full. **(v17 note: the potential used to carry out this
linearization is itself flagged as Gap 20 in this revision — see
P.11.2. Theorem 4a's qualitative carrier-count conclusion survives that
flag; its quantitative mass relation does not, unqualified.)**
...
**[CLASSIFICATION: CONDITIONAL — PROVENANCE UNDOCUMENTED (audit item
P-11; new Gap 20, the root item for Gap 17b and the Theorem 2 v15
note).** The mass term $-m\eta$ is a direct, legitimate readout of
$S_{\text{geo}}$'s $-m\bar\psi\psi$ term. The quadratic-plus-quartic
$(\eta^2+P^2)$-and-$(\eta^2+P^2)^2$ structure of the rest of the
potential — in particular, the extension of the quartic self-coupling
from its stated $\eta$-only form in $S_{\text{geo}}$ (P.1.2:
$-(\lambda/4)(\bar\psi\psi)^2$, i.e. $\eta$ alone) to a full
$(\eta^2+P^2)^2$ form — is not derived here from an exhibited
bosonization of the fermion determinant. No Hubbard-Stratonovich
transform, no fermion determinant, and no regularization/summation
scheme is exhibited anywhere in this section, or cross-referenced from
elsewhere in the document, to justify why the $P$-dependence of the
potential takes this specific chirally-symmetric Mexican-hat form. It
is a plausible ansatz by analogy to standard NJL-model constructions,
consistent with the chiral symmetry identified in P.11.1, but not shown
to be the unique or correct potential following from $S_{\text{geo}}$.
Every quantitative result derived from this potential — the GMOR mass
ratio (Gap 17b), the "independent" confirmation of $P_{\text{eq}}=0$
claimed at Theorem 2's v15 note, and the partial reconciliation
attempted with Theorem 0's $m_{\text{eff}}^2$ formula — inherits this
same tag.]**
...
potential itself, rather than assuming it** — subject to the
classification box above, since this "reproduction" is only as
reliable as the potential producing it. Theorem 2's original proof
(P.3, Fierz identity + assumed vacuum) remains independently sound on
its own terms regardless of this potential's status.
...
as a minor open item for a future consolidation pass — itself now
inheriting the Gap 20 tag, since both quantities being reconciled trace
back to unexhibited effective-potential constructions).

**Mass ratio — a calculable quantity, conditional on Gap 20:**
...
holds — only that it is a specific, calculable-once-the-potential-is
-trusted condition on $\{m,\lambda,\eta_{\text{eq}}\}$, evaluable once
Bi-209 fixes them (CT-vii(a), P.11.6 below) — and, per this revision,
only trustworthy to the extent the potential itself is (Gap 20).
...
regime above). This qualitative consequence (17a) follows from *any*
potential with the correct symmetry structure (nonzero explicit
chiral-breaking term), not only the specific one written above — see
the decomposition applied to Theorem 4a in P.11.4 below.
...
Section 2.4a require no further revision beyond the tag already applied
at Gap 3 above; this paragraph is a different extraction from the same
self-energy function and inherits the same provenance status.**
...
**[CLASSIFICATION (audit item P-2).** **(17a)** The qualitative claim of
this theorem — nondegeneracy of $\delta\eta,\delta P$ as a structural
consequence of explicit chiral-symmetry breaking by $-m\bar\psi\psi$ —
is `ESTABLISHED`; it follows from any potential with the correct
symmetry structure, not only the specific one in P.11.2. **(17b)** The
quantitative relation $m_P^2 = m/\eta_{\text{eq}}$ (the SCH GMOR
relation) is `CONDITIONAL — DOWNSTREAM DEPENDENCY` on Gap 20. It is
only as reliable as the tree-level potential of P.11.2, which has not
itself been shown to follow uniquely from $S_{\text{geo}}$ beyond its
quadratic-and-linear-in-$\eta$ sector.]**

*Basis:* P.11.1–P.11.2; consistent with, and completing (10b), while
carrying the same tag as, Theorem 0 Step 3, and independently
confirming (subject to the same tag) Theorem 2's parity-preserving
vacuum condition.
...
Theorem 3 (Gap 3, CONDITIONAL) but at its $O(\omega)$ imaginary slope.
The two channels have generically distinct damping rates. Propagation
is ballistic ($\tau \sim R/c$) for $R \ll c/\gamma_\phi$ and diffusive
($\tau \sim R^2\gamma_\phi/c^2$) for $R \gg c/\gamma_\phi$,
independently for each channel. No universal, single transport law
applies across all environments or to both channels simultaneously.

*Basis:* P.11.3. *Explicit non-claims:* numerical values of
$\gamma_\eta$, $\gamma_P$, $m_P/m_\eta$ are not established here — see
P.11.6 (CT-vii sub-targets). The qualitative ballistic-vs-diffusive
regime structure of this theorem does not itself depend on Gap 20 or
Gap 3's provenance status — only the numerical damping rates and mass
values extracted from those undocumented constructions do.
...
**Unaffected:** Theorem 3's functional form (P.4), now flagged CONDITIONAL
but structurally unchanged; Paper A Section 2.4a's $\eta$
evolution equation; Theorem 2's parity-preserving vacuum condition on
its own original proof (now separately, and conditionally, "confirmed"
by P.11.2, per audit item P-4); Section P.7.7's cosmological
...
(16a, 16b — the (16c) tag applies only to the separate late-time
smallness claim in P.10, not to this system itself). The latter
concerns homogeneous cosmological background values of the bilinears
evolving under the Cartan equation and the axial current $A^0$; P.11's
fluctuation fields $\delta\eta,\delta P$ concern local spatial
perturbations around a fixed background value. Both sections use the
operator $P=\bar\psi\gamma^5\psi$, but in different contexts
...
*(v17: this evaluation should be read as conditional on Gap 20's
resolution — a numerical answer extracted from an unvalidated
potential is a number about that potential's assumptions, not
necessarily about $S_{\text{geo}}$ itself, until Gap 20 is closed.)*
...
**New (v17), unnumbered:** a derivational target to establish Gap 20 —
i.e., to actually exhibit the Hubbard-Stratonovich transform and
fermion determinant that would justify (or replace) the P.11.2
potential — is a logical prerequisite to CT-vii(a) being read as more
than a self-consistency check on an assumed ansatz. This is noted here
rather than given its own CT number, since numbering it is an editorial
decision for a future full-content revision, not something this
audit-classification pass should do unilaterally.

# **P.12 Gap 19 — CT-xxi: Screening Scale of the Condensate Sector and Closure of the Growth-of-Structure Route**

*Resolves CT-xxi as posed in the DESI-audit thread: whether the (η, A⁰, P) / C_μν sector, via its local fluctuations δη, δP, contributes to linear-order cosmological structure growth (as opposed to
the background expansion route already closed in Section P.10/P.7.7, or
the transport routes closed under Theorem 4b). Unaffected by this
revision's classification pass — its arithmetic was independently
reconfirmed on audit (see the Project-Wide Audit Report, "No action
needed" list).*

## **P.12.1 — Which Picture of η the Question Requires**

Two distinct uses of η exist in this framework and must not be conflated.
**Picture 1** (Paper A §2.3, §2.5): η(Z,N) is a coupling-efficiency
multiplier attached to a given matter configuration, entering
$C_{\mu\nu}=\rho\eta u_\mu u_\nu$ with no independent stress-energy of its
own. **Picture 2** (this Appendix, §P.9 onward): η is the vev of a
dynamical field with its own equation of motion and its own energy
density, entering the Friedmann equation additively.

Under Picture 1, η carries no independent perturbation — it is slaved to
$\delta\rho_m/\rho_m$ by construction, and cannot generate scale- or
redshift-dependent structure not already present in $\delta_m$ itself.
CT-xxi is only non-trivial under Picture 2, where δη and δP (Theorem 4a)
are propagating fields with their own dispersion relation. The remainder
of this section adopts Picture 2, since it is the only reading under
which the four CT-xxi questions are well-posed. If Picture 1 is the
intended cosmological reading, CT-xxi Q1 is answered "no" immediately and
independently of Section P.12.2 below.

## **P.12.2 — The Screening Length**

Extending Theorem 4b's damped relativistic wave equation to a perturbed
background gives, for a comoving mode $k$ of either channel
$\phi\in\{\delta\eta,\delta P\}$:

$$\ddot{\delta\phi} + (3H+\gamma_\phi)\dot{\delta\phi} + \left(\frac{k^2c^2}{a^2}+\frac{m_\phi^2c^4}{\hbar^2}\right)\delta\phi = S_\phi[\Psi,\delta_m]$$

which is the minimal, structurally forced covariant extension of Theorem
4b and is **not independently derived from $S_{\text{geo}}$ here** — it is
adopted for the purpose of identifying which regime the theory is in, and
should itself eventually be derived directly as a further sub-target.

The relevant physical length is the Compton/screening length
$\lambda_{\text{coh}} = \hbar/(m_\phi c)$, i.e. the scale below which the
gradient term dominates the mass term and the field responds locally and
adiabatically to its source, with no independent long-range dynamics — a
Yukawa-screened interaction of range $\lambda_{\text{coh}}$, regardless of
the overall coupling strength $\alpha$.

Using the framework's own existing estimate,
$m_{\text{eff}} \sim 1$–$1.6\times10^{-6}$ eV (Paper A §6.6a; consistent
with the value used in Paper C §2.4):

$$\lambda_{\text{coh}} = \frac{\hbar c}{m_{\text{eff}}c^2} = \frac{1.973\times10^{-7}\ \text{eV·m}}{1.6\times10^{-6}\ \text{eV}} \approx 0.12\ \text{m}$$

**This is a sub-meter, laboratory-scale length, not a cosmological one.**

**Correction of a downstream numerical error.** Paper C §5.1 states, for
this same $m_{\text{eff}}$, "$\lambda_{\text{coh}} \sim 10^{14}$ m — much
larger than any nucleus," used there to argue the condensate is
effectively uniform across nuclear scales. This figure is inconsistent
with the direct evaluation of $\hbar/(m_{\text{eff}}c)$ above by
approximately fifteen orders of magnitude and should be treated as a
computational error, not an alternative convention. The corrected value
($\sim0.1$ m) is still very large compared to a nucleus ($\sim10^{-15}$
m), so **Paper C §5.1's qualitative conclusion (uniform coupling across
nuclear scales) is unaffected** — only the specific quoted length, and
any claim built on the *cosmological* reach of that length, requires
correction. The same unstated assumption — asserting long range from this
mass value without computing $\lambda_{\text{coh}}$ explicitly — also
appears in the now-retracted black hole frequency discussion at former
§P.7.5.2 ("$m_{\text{eff}} \sim 1.6\times10^{-6}$ eV/c² (sub-meV,
consistent with long-range condensate)"); that claim was independently
wrong on this same numerical point even before its retraction on
transport-law grounds.

## **P.12.3 — Consequence for Cosmological Structure Growth**

At $\lambda_{\text{coh}}\approx0.1$ m, the mass term dominates the
gradient term, $k^2c^2/a^2 \ll m_\phi^2c^4/\hbar^2$, for every comoving
wavenumber $k$ accessible to any large-scale-structure survey (BAO, RSD,
weak lensing all probe $k$ corresponding to Mpc-and-larger scales, more
than twenty orders of magnitude longer than $\lambda_{\text{coh}}$). In
this regime $\delta\phi$ is not an independently propagating cosmological
perturbation: it tracks its local source term $S_\phi[\Psi,\delta_m]$
adiabatically and is screened on all scales of cosmological interest,
exactly as a heavy scalar is screened out of large-scale dynamics in
standard scalar-tensor constructions.

## **P.12.4 — Answers to CT-xxi**

**Q1 — Does SCH contribute at linear order before virialization?**
No, under the framework's own stated value of $m_{\text{eff}}$, in either
Picture 1 (trivially, no independent perturbation exists) or Picture 2
(the field is screened at all survey-relevant $k$).

**Q2 — What does it modify?** Nothing at cosmological $k$; the question
is moot given Q1.

**Q3 — Scale-dependent or scale-independent?** Moot given Q1. (For
completeness: were $m_{\text{eff}}$ many orders of magnitude smaller, the
natural expectation would be scale-dependence of $\mu(k,a)$-type, via the
matter-coupling term already present in Paper C §2.1,
$\mathcal{L}_{\text{coupling}}=\alpha(\eta/m_{\text{eff}}^2)\bar\psi_f\psi_f$,
extended to all fermion species. This is noted only to record the
structural shape the mechanism would take, not as a live possibility.)

**Q4 — Is the sign/redshift dependence in the ballpark of DESI-era
tensions?** Moot given Q1.

## **P.12.5 — Status and Scope of This Closure**

This closure is **contingent on $m_{\text{eff}}$ remaining within the
range already used self-consistently throughout this framework**
(Paper A §6.6a; Paper C §2.4, §5.1). Rescuing Branch D would require
$m_{\text{eff}}$ to be smaller by roughly twenty or more orders of
magnitude than every other place this quantity is used in the
framework — not a calibration uncertainty within the Bi-209 programme's
expected scope, but a value inconsistent with the framework's own
existing estimate at the level the estimate is currently trusted. Absent
such a revision, this is a structural closure, of the same character as
the Branch A–C closures in the DESI audit: it follows from a length-scale
comparison, not from an undetermined coefficient, and is not gated on the
Bi-209 calibration in the way genuinely open targets (CT-vii, CT-xix,
CT-xx) are.

**What remains open, stated narrowly.** (i) The covariant linear
perturbation equation of P.12.2 is adopted by analogy to Theorem 4b, not
independently derived from $S_{\text{geo}}$ on a perturbed background;
a first-principles derivation is a legitimate residual target if this
sector is revisited. (ii) The Picture 1/Picture 2 ambiguity in what
cosmological "η" denotes (§P.12.1) is a standing documentation gap
independent of this closure and should be resolved for its own sake.
(iii) The numerical correction to Paper C §5.1 (§P.12.2) should be made
at its source; it does not affect that section's qualitative conclusion
but should not be left standing at its current, incorrect value.

**Downstream effect on the DESI question.** Combined with the prior
closure of Branches A–C, this closes the growth-of-structure route
(Branch D) that was proposed as the remaining live category for a DESI
connection. All four branches considered to date — ballistic transport,
environmental/localized transport, background expansion-history, and
linear growth-of-structure — are closed on structural grounds. No
mechanism currently derivable from $S_{\text{geo}}$ produces a
cosmological-scale signature relevant to DESI-era expansion or growth
measurements.

---

*End of Appendix P — v17.*

*June 2026 | Incorporates the v15 Theorem 4 split in full, and, new in
this revision, the eleven classification corrections (audit items P-1
through P-11) from `SCH_Project_Wide_Audit_Report_v1.md`, Section 2.*

*Summary of v17 changes relative to v16 (full reproduction per this
document's own no-elision policy — see the scope note in the revision
header at the top): (1) STATUS SUMMARY table updated: Gap 3 downgraded
to CONDITIONAL (P-6); Gap 6 downgraded to COMPATIBILITY (P-3); Gap 9
annotated with CP-01 (P-7); Gap 10 decomposed into 10a/10b/10c (P-5,
P-8); Gap 11 decomposed into 11a/11b (P-9); Gap 12 decomposed into
12a/12b (P-10); Gap 16 decomposed into 16a/16b/16c (P-1); Gap 17
decomposed into 17a/17b (P-2); new Gap 20 added (P-11). (2) P.6 Closure
Summary table updated identically. (3) Classification boxes inserted
in-line at: P.0b.2 (CP-01), Theorem 0 Step 3 and Conclusion (P-5,
CP-02), Theorem 2's v15 note (P-4), Theorem 3/P.4 (P-6), Theorem 5 Step
3 (P-9), Theorem 6 Step 4 (P-10), P.7.6.2 (P-3, prose already adequate,
table-only correction), P.7.7.3a and Section P.10 (P-1, the (16c) tag),
Theorem 4a and P.11.2 (P-2, P-11, new Gap 20). (4) No equation,
coefficient, derivation step, or numerical result is altered anywhere
in this document relative to v16 — every change is a label, a split, or
an inserted classification box, per the Reconstruction Firewall. (5)
This is a full-text reproduction, not a patch list, per explicit
instruction and consistent with this document's own stated no-elision
standard.*
