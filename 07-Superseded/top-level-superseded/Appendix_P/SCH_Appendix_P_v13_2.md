...
**1b and 1c are unblocked and may now proceed in parallel; 1d is unblocked
and downgraded to a notational reconciliation.** Updated order: **1a
(closed) → {1b, 1c in parallel} → 1d.** Only after IVN-CT8-Dirac-1 fully
closes (1b and 1c independently verified) should the canonical rewrite of
P.9.4.2, P.9.5.3, P.7.7.3, P.7.7.3a, and CT-ix Section P.10.5 be
performed, in one pass. The freeze established in this section remains in
effect for the Dirac/bilinear sector until that rewrite — 1a's closure
