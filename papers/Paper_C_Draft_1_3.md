...
*Full Framework Release. Companion to Paper A (Draft 2.2), Paper B (Draft 1.6), and Appendix P (v9).*
...
Calculational targets CT-i through CT-xiii are defined in Appendix P Section P.8 (v8 carries these forward unchanged). Paper C adds CT-xiv through CT-xviii, defined in Section 6 of this paper. Proof targets PT-1 through PT-4 are defined in Appendix P Section P.7.7 and Appendix C Section C.7. No new proof targets are added in Paper C; the leptonic mass modification derivation is framed as a calculational target (CT-xiv) rather than a proof target because it does not bear on the formal closure of the variational theory established in Appendix P. Note that Appendix P v8 adds Section P.0b and Theorems 0, 5, and 6, which formally ground the physical primitive, the identification of η as w-spin magnitude, and the matter-light phase transition. These additions strengthen but do not alter any claim in Paper C.
...
*Companion documents: Paper A Draft 2.2 | Paper B Draft 1.6 | SCH Appendix P v9*
