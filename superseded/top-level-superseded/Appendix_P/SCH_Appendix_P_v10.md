...
**Working Proof Document — v10 | June 2026**
...
*Full derivation in companion document: SCH_CT_viii_FLRW_Reduction.md. The derivation is incorporated here by reference pending final formatting for the submission package. Section numbering P.9.1 through P.9.10 follows the companion document structure.*

**Summary of results** (full derivation in SCH_CT_viii_FLRW_Reduction.md):

The modified Friedmann equations on $S^3 \times \mathbb{R}$ are:
...
The cosmological Dirac equation:

$$i\gamma^0\dot\psi = \frac{3H}{2}\gamma^0\psi + m\psi + \frac{\lambda}{2}\eta\psi + \frac{\kappa\alpha}{2}A^0\gamma^0\gamma^5\psi$$

The bounce existence condition:

$$\frac{\lambda}{2}\eta^2 + 2m\eta > \kappa\alpha(A^0)^2$$

**New results established by the derivation:**

1. Two-branch cosmology: the torsion-free branch ($A^0 = 0$) and the torsion-active branch ($A^0 \neq 0$) are both consistent. PT-1 determines which branch is physical.
2. Bounce regularity: the bounce is a regular point of the cosmological Dirac equation. No singularity. $\psi(t)$ is continuous through the turnaround.
3. Kinetic coefficient $-3/2$: derived explicitly in P.9.4.1. Corrects the informal $+3/2$ in earlier working documents.
4. Spatial bilinears vanish on $S^3$: the $\gamma_1$ and $\gamma_2$ contributions to the reduced kinetic term integrate to zero — a topological result of the closed $S^3$.
5. Comoving vector charge conserved through the bounce: $a^3\bar\psi\gamma^0\psi = \mathcal{J} = \text{const}$.

**GR recovery:** Setting $\eta \to 0$, $A^0 \to 0$: standard $k=+1$ Friedmann equations recovered exactly. $\checkmark$

**Prerequisites for PT-1 delivered:** The cosmological Dirac equation, bounce regularity, two-branch structure, and formal framework for the spinor transformation under the antipodal map are all established. PT-1 must determine the transformation law for $A^\mu$ under the combined spatial antipodal map and temporal reversal at the bounce — this is not established by CT-viii alone.

---

**End of Appendix P — v10**
